...
const std::vector<CornerDef> kCorners = {
    {"cloud", {{1, 3}, {4, 0.55}, {6, 0.0}, {8, 0.35}, {39, 1.0}, {14, 1.0}}},
    {"lock", {{1, 16}, {4, 0.30}, {6, 1.0}, {8, 0.35}, {39, 1.0}, {14, 1.0}}},
    {"splay", {{1, 16}, {4, 0.30}, {6, -1.0}, {8, 0.35}, {39, 1.0}, {14, 1.0}}},
    {"two-cluster",
     {{1, 16}, {4, 0.30}, {6, 1.0}, {8, 0.35}, {24, 2}, {26, 0.6}, {56, 1.0}, {39, 1.0}, {14, 1.0}}},
};

/* Shorthand for the morph-exemplar corner row. */
#define QM_CORNERS {"cloud", "lock", "splay", "two-cluster"}
#define NO_CORNERS {"", "", "", ""}
